...
@PropertyConfig(name = "source",
        propertyClass = String.class,
        propertyReadWrite = WRITE_ONLY)
@PropertyConfig(name = "forceLengthBreakCount",
        propertyClass = int.class,
        required = true,
        propertyReadWrite = WRITE_ONLY)
@PropertyConfig(name = "abridgedLengthCount",
        propertyClass = int.class,
        required = true,
        propertyReadWrite = WRITE_ONLY)
@VerifyConstructor(of = "source")
@VerifyConstructor(of = { "source", "forceLengthBreakCount", "abridgedLengthCount" })
class TextSplitterTest extends ValueObjectTest<TextSplitter> {
